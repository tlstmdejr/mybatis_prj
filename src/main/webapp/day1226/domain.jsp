...
%>
<c:out value="${param.deptno }(${param.empno })"/>사원정보 조회결과<br>
<c:choose>
<c:when test="${not empty empDomain }">
사원명 : <c:out value="${empDomain.ename }"></c:out>
연봉 : <c:out value="${empDomain.sal }"></c:out>
보너스 : <c:out value="${empDomain.comm }"></c:out>
